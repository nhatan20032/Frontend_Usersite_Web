      ...
      <div className="apple-glass-modal max-w-md w-full rounded-[28px] p-6 sm:p-8 space-y-4 relative shadow-2xl">
        ...
        <div className="space-y-3 text-xs app-text-primary">
          <div className="flex items-center gap-2.5">
            ...
            <span>
              Thời gian: <b>{`${event.time} (Ngày ${event.day} ${monthNames[selectedMonth]})`}</b>
            </span>
          </div>
          ...
          {isRoutine ? (
            <div className="flex items-center gap-2.5">
              ...
              <span>
                Kỷ luật Streak: <b className="text-amber-600 dark:text-amber-400">{event.streak || 1} ngày liên tục</b>
              </span>
            </div>
          ) : (
            <div className="space-y-2">
              <div className="flex items-center gap-2.5">
                ...
                <span>
                  Địa điểm: <b>{event.location || 'Hà Nội'}</b>
                </span>
              </div>
              <div className="apple-glass-pill p-3.5 rounded-2xl space-y-1.5">
                <div className="flex items-center justify-between text-[11px]">
                  <span className="flex items-center gap-1">
                    ...
                    <span>Lộ trình: 8.4 km</span>
                  </span>
                  <span className="font-bold text-emerald-600 dark:text-emerald-400">25 phút</span>
                </div>
                <div className="text-[11px] text-amber-600 dark:text-amber-400 font-semibold bg-amber-500/10 p-2 rounded-xl border border-amber-500/20 flex items-center gap-1.5">
                  ...
                  <span>Khuyến nghị: Xuất phát lúc 13:35 PM</span>
                </div>
              </div>
            </div>
          )}
